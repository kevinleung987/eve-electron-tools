  ...
  constructor(public universe: UniverseService) {
    this.mails.push({
      ...
      'zkb': {
        ...
        'solo': false,
        'awox': false,
        'esi': 'https://esi.evetech.net/latest/killmails/72883408/ce0abbe614ec6e5d1020964eebc6974157df3b16/',
